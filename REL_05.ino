/* 
 *  Projeto: controle e monitoramento de periféricos no ESP32 via MQTT com app MQTT DASH
 *  Autores: Pedro Bertoleti e FilipeFlop
 *  Data: Fevereiro/2019
 *
 *  *****************
 *  
 *  Adaptado Por Hernane Velozo 
 *  Data: 22/05/2022
 */
#include <DHT.h>
#include <WiFi.h>
...
#define TOPICO_PUBLISH_TEMPERATURA   "topico_sensor_temperatura1" 
#define TOPICO_PUBLISH_DISTANCIA     "topico_sensor_distancia" 
#define TOPICO_PUBLISH_UMIDADE       "topico_sensor_umidade1" 
...
const char* SSID = "HNs Networks"; // SSID / nome da rede WI-FI que deseja se conectar
const char* PASSWORD = "AB3HS0@92A"; // Senha da rede WI-FI que deseja se conectar
